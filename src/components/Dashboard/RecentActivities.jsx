...
function RecentActivities({ activities: propActivities }) {
  // Use passed prop activities if provided, fallback to localStorage read.
  const activities = propActivities || getActivities();
          ...
          {activities.length === 0 ? (
            ...
            <ul className="list-group list-group-flush">
              {activities.map((activity) => {
                const config = activityConfig[activity.type] || activityConfig.edit;
