...
const FallAlertModal = ({ alert, onClose, onAcknowledge }) => {
  ...
  // Phát âm thanh còi báo động khẩn cấp (Dual-Tone Siren) bằng Web Audio API
  useEffect(() => {
    let audioCtx = null;
    let interval = null;
    let toggle = false;
    ...
    try {
      ...
      const playSiren = () => {
        ...
        // Bắt buộc resume nếu trình duyệt chặn tự động phát âm thanh
        ...
        // Tần số còi cấp cứu luân phiên: 960 Hz và 770 Hz
      ...
      playSiren();
      interval = setInterval(playSiren, 400);
    } catch (e) {
